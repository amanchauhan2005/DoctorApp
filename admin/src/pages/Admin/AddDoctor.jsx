    ...
    <form  className="m-5 w-full" onSubmit={onSubmitHandler}>
      ...
      <div className="bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll">
        ...
        <div className="flex flex-col lg:flex-row items-start gap-10 text-gray-600 ">
          ...
          <div className='w-full lg:flex1 flex flex-col gap-4'>
            <div className='flex-1 flex flex-col gap-1'>
              <p>Speciality</p>
            ...
            <div className='flex-1 flex flex-col gap-1'>
              ...
              <textarea onChange={(e)=>setabout(e.target.value)} value={about} className=' w-full px-4 pt-2 border rounded'
                ...
                required
              />
              <button type='submit' className='bg-primary  text-white rounded px-3 py-3 mt-2'>Add Doctor</button>
            </div>
          </div>
          </div>
        </div>
